        ...
        if(cfg.welcome == "text"){
          ...
          let welcome = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    thumbnailUrl: pp,
                    sourceUrl: "https://github.com/AlwaysBoytzz",
                    mediaUrl: `http://ẉa.me/6285960166234/${Math.floor(Math.random() * 100000000000000000)}`,
         ...
         Exp.relayMessage(cht.id, {
           "orderMessage": {
             ...
             "sellerJid": "6285960166234@s.whatsapp.net",
         ...
         Exp.relayMessage(cht.id, {
          "productMessage": {
            ...
            "businessOwnerJid": "6285960166234@s.whatsapp.net",
              "contextInfo": {
                "expiration": 86400,
